export const SSO_LOGIN = `${process.env.NEXT_PUBLIC_SSO_BASE_URL}auth/login`
export const SSO_REGISTER = `${process.env.NEXT_PUBLIC_SSO_BASE_URL}auth/register`
export const USER_PROFILE = `${process.env.NEXT_PUBLIC_SSO_BASE_URL}users/profile`
